...
process.env.MONGODB_URI = "mongodb://dou:xdll241xd@cluster0-shard-00-00.kb07l.mongodb.net:27017,cluster0-shard-00-01.kb07l.mongodb.net:27017,cluster0-shard-00-02.kb07l.mongodb.net:27017/Cluster0?ssl=true&replicaSet=atlas-7tek14-shard-0&authSource=admin&retryWrites=true&w=majority"
...
promise.then(
  () => {
    ...
    var Basket = mongoose.model("Basket");
